...
interface QuestionsScreenProps {
  ...
  onSubmit: (answers: PatientAnswers) => void | Promise<void>;
}
  ...
  return (
    <div className="min-h-screen bg-[#F9FBFF] p-4 pb-20">
      ...
      <button
        ...
        disabled={isLoading}
        className={`w-full mt-6 py-4 px-6 rounded-2xl font-medium text-lg shadow-lg transition-all duration-200 flex items-center justify-center gap-3 ${isLoading
            ? 'bg-gray-400 cursor-not-allowed shadow-none'
            : 'bg-[#2F80ED] hover:bg-[#2563eb] text-white shadow-blue-200'
          }`}
      >
        {isLoading ? (
          <>
