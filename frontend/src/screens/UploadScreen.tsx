            ...
            {isValidating && (
              <div className="absolute inset-0 bg-black/50 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-medium">Validating image...</p>
                </div>
              </div>
            )}
              ...
              <div className="absolute inset-0 bg-black/75 rounded-xl flex items-center justify-center p-4">
                <div className="bg-white rounded-xl p-6 max-w-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-semibold text-gray-800">Validation Failed</h4>
                  </div>
              ...
              <div className="absolute inset-0 bg-black/75 rounded-xl flex items-center justify-center p-4">
                <div className="bg-white rounded-xl p-6 max-w-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-semibold text-gray-800">Healed Wound</h4>
                  </div>
                  <p className="text-sm text-gray-700 mb-4">{validationResult.message}</p>
            ...
            {previewAnalysis && !isAnalyzing && validationResult?.isValid && (
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 rounded-b-xl">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white text-sm font-medium">✓ Validated & Analyzed</span>
      ...
      >
        ...
        {isValidating
          ...
          : validationResult?.isHealed
            ? 'Healed Wound - No Analysis Needed'
