    ...
    <div className="min-h-screen bg-[#F9FBFF] p-4 pb-20 transition-colors duration-200">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-md mb-4 transition-colors">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-semibold text-gray-800">{t('developerOptions')}</h3>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-gray-700 block">{t('resetOnboarding')}</span>
              <span className="text-xs text-gray-400">Clear seen state and restart app</span>
            </div>
          </div>
          <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
